...
j++;}
if(a_to_vh==false)
{var encryptedUrl=Base64.encode(a_to_vi);var x=Math.floor((Math.random()*10)+1);var xxx=null;if(x=="1"){xxx="/2019/08/manufacturing-capacity-planning-software.html"}
...
if(x=="10"){xxx="/2019/08/manufacturing-software-free-download.html"}a_to_ve[i].href="https://erp.golifehd.com"+xxx+"?url="+encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+a_to_ve[i].href+"\n";}}
